...
```
Chem insights on supported dispensary menus. Free hover/compare; Pro via Stripe on our site. Not medical advice.
```

## Detailed description

```
CannabisSage is a Chrome extension for supported dispensary menus.

Free features:
• Hover tooltips and basic chem badges
• Compare tray (up to 3 products)
• Product detail panel on supported menus
...
• Chem insights across more stores you shop
...
4. Upload `dist/cannabis-sage-1.3.10.zip` (CWS **1.3.2** may still be pending review; next upload needs this bump).
