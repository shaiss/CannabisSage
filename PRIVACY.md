...
5. **CannabisSage site (network):** Entitlement APIs and a small HTTPS **denylist JSON** (`/denylist.json`) — configuration only, never executable code. See [`docs/DENYLIST.md`](docs/DENYLIST.md).
